...
@section('title', __('ui.potential_page_title'))
    ...
    <section class="page-banner">
        <div class="page-banner-inner">
            <div class="breadcrumb">
                ...
                <i class="fa fa-chevron-right"></i>
                <span>{{ __('ui.potential_page_title') }}</span>
            </div>
            <h1><i class="fa fa-gem"></i> {{ __('ui.potential_page_title') }}</h1>
            <p>{{ __('ui.potential_page_desc') }}</p>
        </div>
    </section>
        ...
        <div class="main-content">
            ...
            <section class="section-block">
                <div class="section-header">
                    <div class="section-title-group">
                        ...
                        <h2 class="section-title">{{ __('ui.potential_page_title') }}</h2>
                    </div>
                </div>
                <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:22px;">
                    ...
                    @foreach ($categories as $category)
                        <a href="{{ route('potensi', ['kategori' => $category->slug]) }}"
            ...
            <section class="section-block">
                <div class="berita-grid">
                    ...
                    @empty
                        <p>{{ __('ui.informasi_no_potential') }}</p>
                    @endforelse
                </div>
                ...
                @if ($potentials->hasPages())
                    <div style="margin-top:32px;display:flex;justify-content:center;">
                        {{ $potentials->appends(request()->query())->links() }}
                    </div>
                @endif
            </section>
